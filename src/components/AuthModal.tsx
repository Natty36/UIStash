            ...
            <div className="p-6 sm:p-7">
              ...
              <div className="space-y-2.5 mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-zinc-900 hover:bg-zinc-800/90 text-zinc-200 border border-zinc-800 rounded-xl text-xs font-medium transition-all active:scale-[0.98] disabled:opacity-50 font-mono shadow-sm"
                >
              ...
              <div className="relative mb-6 flex items-center justify-center">
                ...
                <span className="relative px-3 bg-zinc-950 text-[10px] text-zinc-500 uppercase font-mono tracking-wider">
                  or email
                </span>
              </div>
              ...
              {error && (
                <motion.div
                  ...
                  className="mb-4 p-3 rounded-xl bg-red-500/10 border border-red-500/30 text-red-400 text-xs font-mono flex items-start gap-2.5"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Email Address Field (Always shown for both Sign In and Sign Up) */}
                    <div className="space-y-1.5">
                      <label className="text-[11px] text-zinc-400 font-mono font-medium">
                        Email Address
                      </label>
