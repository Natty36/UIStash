...
export const resourcesData: Resource[] = [
  ...
  { id: 134, title: "OriginKit", desc: "Beautiful, accessible components crafted with Tailwind CSS and Radix UI.", url: "https://www.originkit.dev/", category: "UI Components & Blocks", tags: ["Tailwind", "Radix", "Components"], newRelease: true, chefsChoice: true },
  ...
  { id: 131, title: "React Bits", desc: "An open source collection of animated, interactive & fully customizable React components.", url: "https://www.reactbits.dev/", category: "UI Components & Blocks", tags: ["React", "Animation", "Tailwind"], trending: true, newRelease: true, chefsChoice: true },
  { id: 133, title: "Hover.dev", desc: "Animated Tailwind CSS & Framer Motion components ready to copy and paste.", url: "https://www.hover.dev/", category: "UI Components & Blocks", tags: ["Animation", "Tailwind", "Framer Motion"], trending: true, chefsChoice: true },
  ...
  { id: 145, title: "GSAP", desc: "Professional-grade JavaScript animation engine for high-performance motion.", url: "https://gsap.com/", category: "Animations & 3D", tags: ["GSAP", "Animation", "Performance"], trending: true, chefsChoice: true },
  ...
  { id: 144, title: "Sketchfab", desc: "Publish, share, buy, and download interactive 3D models and assets.", url: "https://sketchfab.com/", category: "Animations & 3D", tags: ["3D", "Assets", "Models"], chefsChoice: true },
  ...
  { id: 148, title: "Framer", desc: "Design and publish responsive, animated websites visually with zero code.", url: "https://www.framer.com/", category: "Design & Prototyping", tags: ["Design", "Website Builder", "Interactive"], trending: true, chefsChoice: true },
  { id: 106, title: "Relume Library", desc: "The world's largest Webflow and Figma component library.", url: "https://library.relume.io/", category: "Design & Prototyping", tags: ["Webflow", "Figma", "Wireframe"], chefsChoice: true },
  ...
  // --- Typography & Fonts ---
  { id: 52, title: "Google Fonts", desc: "The #1 resource for free and easy-to-use webfonts.", url: "https://fonts.google.com/", category: "Typography & Fonts", tags: ["Fonts", "Free"], chefsChoice: true },
  { id: 154, title: "UNCUT.wtf", desc: "A curated contemporary catalogue of open-source and free typefaces.", url: "https://uncut.wtf/", category: "Typography & Fonts", tags: ["Fonts", "Typefaces", "Contemporary"], trending: true, newRelease: true, chefsChoice: true },
  ...
  // --- Colors & Gradients ---
  { id: 137, title: "Colors by Robi", desc: "Curated aesthetic color palettes and gradient collections.", url: "https://colors.robi.work/", category: "Colors & Gradients", tags: ["Colors", "Curated", "Palettes"], chefsChoice: true },
  { id: 136, title: "Coolors", desc: "The super fast color palettes generator.", url: "https://coolors.co/", category: "Colors & Gradients", tags: ["Colors", "Palettes", "Generator"], trending: true, chefsChoice: true },
  { id: 61, title: "Colorhunt", desc: "Curated collection of beautiful color palettes.", url: "https://www.colorhunt.co/", category: "Colors & Gradients", tags: ["Colors", "Palettes"], chefsChoice: true },
  ...
  { id: 63, title: "UI Gradients", desc: "Collection of beautiful color gradients.", url: "https://uigradients.com/", category: "Colors & Gradients", tags: ["Colors", "Gradients"], chefsChoice: true },
  ...
  // --- Hosting ---
  { id: 171, title: "Cloudflare Pages", desc: "Fast, secure edge hosting and full-stack platform for frontend developers.", url: "https://pages.cloudflare.com/", category: "Hosting", tags: ["Hosting", "Edge", "Fast"], trending: true, chefsChoice: true },
  { id: 173, title: "EthioDeploy", desc: "Push to GitHub, deploy instantly. Built for developers with local Birr billing.", url: "https://ethiodeploy.com/", category: "Hosting", tags: ["Hosting", "Deployment", "Local"], newRelease: true, trending: true, chefsChoice: true },
  { id: 8, title: "Vercel", desc: "Develop. Preview. Ship. Optimized deployment platform for modern frontend teams.", url: "https://vercel.com", category: "Hosting", tags: ["Hosting", "Frontend", "Next.js"], trending: true, chefsChoice: true },
